defmodule Spejs.Web.DeviceControllerTest do
  ...
  @create_attrs %{identifier: "some identifier", name: "some name", user_id: 42}
  @update_attrs %{identifier: "some updated identifier", name: "some updated name", user_id: 43}
  @invalid_attrs %{identifier: nil, name: nil, user_id: nil}
